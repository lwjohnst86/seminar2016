...
Put image of Nature commentary about putting code online and about scientists using GitHub.
...
- Include bit about code available to look over via github
...
<!--
```{r img_pvalue_problem, out.width='250px', echo=FALSE, fig.align='center', fig.cap='Prof. David Colquhuon'}
